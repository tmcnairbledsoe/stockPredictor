...
class BasicModelDSFV(Model):
    def __init__(self, df):
        self.name = 'BasicModelDSFV'
        self.numInput = 4
        self.numOutput = 1
...
class BasicModelEpochs30(Model):
    def __init__(self, df):
        self.name = 'basicEpochs30'
        self.numInput = 1
        self.numOutput = 1
        self.inputs = ['Difference']
        self.outputs = ['Difference']
...
class BasicModelEpochs40(Model):
    def __init__(self, df):
        self.name = 'basicEpochs40'
        self.numInput = 1
        self.numOutput = 1
        self.inputs = ['Difference']
        self.outputs = ['Difference']
...
class BatchClipEarlyStopD(Model):
    def __init__(self, df):
        self.name = 'BatchClipEarlyStopD'
        self.numInput = 1
        self.numOutput = 1
        self.inputs = ['Difference']
        self.outputs = ['Difference']
...
class BatchClipEarlyStopDSFV(Model):
    def __init__(self, df):
        self.name = 'BatchClipEarlyStopDSFV'
        self.numInput = 4
        self.numOutput = 1
        self.inputs = ['Difference','slowsma','fastsma','Volume']
        self.outputs = ['Difference']
...
class BatchClipEarlyStopValLossD(Model):
    def __init__(self, df):
        self.name = 'BatchClipEarlyStopValLossD'
        self.numInput = 1
        self.numOutput = 1
        self.inputs = ['Difference']
        self.outputs = ['Difference']
    ...
    def build(self):
        ...
        for i in range(1, maxSteps):
            ...
            early_stopping = EarlyStopping(monitor='val_loss', mode='min', baseline=0.4, restore_best_weights=True)
            # Train the model (you can adjust the number of epochs and batch size)
            model.fit(X, y, validation_split=0.3, epochs=100, callbacks=[early_stopping])
